...
from jaxns.allocation import VolumePath
from jaxns.allocation import evidence_improvement_utility
from jaxns.allocation import expected_volume_path
from jaxns.allocation import integer_allocation_targets
from jaxns.allocation import normalise_allocation_utility
from jaxns.allocation import posterior_improvement_utility
...
def test_expected_volume_path_uses_v3_dirichlet_p_gt_means():
...
def test_build_utility_allocation_plan_uses_v3_summaries_and_shared_targets(
        allocation_target,
):
    state = _make_state(
        root_out_degree=3,
