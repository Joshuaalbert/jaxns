...
def get_polynomial_form():
    ...
    def loss(Q):
        def single_loss(single_datum):
            ...
            return (vmap(lambda gamma_prime: cumulative_tomographic_weight_dimensionless_polynomial(Q, gamma_prime, n, w1, w2))(gamma_prime) - cdf_ref)**2
    ...
    def do_sgd(key):
        def body(state,X):
            ...
            def loss(Q):
                return jnp.mean((vmap(lambda gamma_prime: cumulative_tomographic_weight_dimensionless_polynomial(Q, gamma_prime, n, w1, w2))(gamma_prime) - cdf_ref)**2) #+ 0.1*jnp.mean(Q**2)
