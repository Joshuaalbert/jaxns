...
class Reservoir(NamedTuple):
    """
    Holds the reservoir of samples, used during adaptive integration.
    """
    ...
    log_L: jnp.ndarray  # [N] log likelihood of live init_U
    num_likelihood_evaluations: jnp.ndarray  # [N]
    available: jnp.ndarray  # [N]
...
class SampleCollection(NamedTuple):
    ...
    log_L: jnp.ndarray  # [max_samples] -- The log-likelihood of sample.
...
class ThreadStats(NamedTuple):
    ...
    init_i_main: jnp.ndarray
    log_L_entry: jnp.ndarray
...
class NestedSamplerState(NamedTuple):
    ...
    reservoir: Reservoir  # Holds the reservoir of samples, used during adaptive integration.
    ...
    thread_idx: jnp.ndarray  # the iteration of thread
