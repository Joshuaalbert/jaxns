...
class ZMQActor(ABC):
    ...
    def new_socket(self, sock_type, *, bind=None, connect=None, no_hwm: bool = True, sockopts: dict | None = None, **opts) -> zmq.Socket:
        ...
        if sockopts is not None:
            for opt_name, opt_val in sockopts.items():
                s.setsockopt(opt_name, opt_val)
