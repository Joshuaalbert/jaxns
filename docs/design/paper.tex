...
\begin{align}
    M'_{>g} =& M_{>g} + \mathbf{1}\{C^{\rm Kish}_g \ge C_0\} \sum_c v_c B_{cg}\\
    M'_{=g} =& M_{=g} + \mathbf{1}\{C^{\rm Kish}_g \ge C_0\} \sum_c v_c E_{cg}\\
    M'_{<g} =& M_{<g} + \mathbf{1}\{C^{\rm Kish}_g \ge C_0\} \sum_c v_c A_{cg}\\
    p_g =& \frac{(M'_{>g}, M'_{=g}, M'_{<g})^\top}{M'_{>g} + M'_{=g} + M'_{<g}}.
\end{align}
